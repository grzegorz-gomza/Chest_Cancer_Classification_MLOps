...
from box.exceptions import BoxValueError  # Exception class for Box configuration errors
...
def read_yaml(yamlPath: Path) -> ConfigBox:
    ...
    try:
        ...
        print(f"Error reading yaml file: {yamlPath}\n Error: {e}")
...
def load_json(jsonPath: Path) -> ConfigBox:
    ...
    try:
        ...
        print(f"Error reading json file: {jsonPath}\n Error: {e}")
